...
void INTROJOY_sound()
{
  JOY_sound(80, 55); JOY_DLY_ms(20); JOY_sound(90, 55); JOY_DLY_ms(20); JOY_sound(100, 55); JOY_sound(115, 255); JOY_sound(115, 255);
}
void VICTORYJOY_sound()
{
  JOY_sound(111, 100); JOY_DLY_ms(20); JOY_sound(111, 90); JOY_DLY_ms(20); JOY_sound(144, 255); JOY_sound(144, 255); JOY_sound(144, 255);
}

void ALERTJOY_sound()
{
  JOY_sound(150, 100); JOY_DLY_ms(100); JOY_sound(150, 90); JOY_DLY_ms(100); JOY_sound(150, 100);
}

void HAPPYJOY_sound()
{
  JOY_sound(75, 90); JOY_DLY_ms(10); JOY_sound(114, 90); JOY_sound(121, 90);
}
